export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center py-36">
        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 mb-8 text-sm font-medium">
          <span>🌱</span> Student-Owned & Locally Operated · Northwest Arkansas
        </div>

        <h1 className="font-display font-extrabold text-5xl md:text-7xl leading-tight mb-6">
          Reliable Lawn Care<br />
          <span className="text-brand-lime">&amp; Landscaping</span><br />
